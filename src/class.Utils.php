...
class Utils {
	public static function createDBTables($dbName) {
		...
		if ($mysqli->connect_errno) {
			...
			if ($result) {
				...
				$createTable = 'create table gamescores (userid BIGINT,appid BIGINT,score BIGINT,timestamp DATETIME,index(userid),index(score),index(timestamp));';
	...
	public static function createFakeLeaderBoardData($appId = FB_APPID) {
		// Use Pacific Time
